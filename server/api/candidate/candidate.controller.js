...
// Return statistic for several positions
// http://localhost:9000/api/candidates/stats/month/?positions=foo&positions=bar
export function statsByMonthByPositions(req, res){
